...
/**
 * Created by TRILE on 15/03/2018.
 */
...
public class AdapterNew extends RecyclerView.Adapter<AdapterNew.ViewHolder> {
    ...
    private com.example.group6.dulichdoday.Adapter.AdapterComment adapterComment;
    private TextView tv;
    ...
    public void onBindViewHolder(final AdapterNew.ViewHolder holder, final int position) {
        ...
        adapterComment = new com.example.group6.dulichdoday.Adapter.AdapterComment(arrayListComment,context);
